...
4. Enable the Marketplace API
    * Producer Portal:
        ...
        * See [Producer Portal Pre-requistites](./../frontend/user-guide/PRODUCER_PORTAL/#producer_portal_prerequisites) for more information.
    * Partner Portal:
        ...
        * See [Partner Portal Pre-requistites](./../frontend/user-guide/PARTNER_PORTAL/#partner_portal_prerequisites) for more information.
