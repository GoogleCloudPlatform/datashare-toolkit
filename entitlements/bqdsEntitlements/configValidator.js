...
async function validateSchema(config) {
    ...
    let accessSchema = {
        ...
        "properties": {
            ...
            "iamMember": { "type": "string" },
        },
        "format": "accessValidator"
    }
    ...
    let viewSchema = {
        ...
        "required": ["name", "datasetNames"]
    }

    let expirationSchema = {
        "id": "/Expiration",
        "type": "object",
        "additionalProperties": false,
        "properties": {
    ...
    expirationSchema.properties.time.minimum = (new Date()).getTime();

    let publicAccessSchema = {
        "id": "/PublicAccess",
        "type": "object",
        "additionalProperties": false,
        "properties": {
    ...
    let sourceSchema = {
        ...
        "properties": {
            ...
            "accessControl": { "$ref": "/SourceAccessControl" }
        },
        "required": ["datasetId", "tableId"]
    }

    let sourceAccessControlSchema = {
    ...
    let configSchema = {
        ...
        "properties": {
            ...
            "accessControl": { "$ref": "/ConfigAccessControl" },
            "groups": {
                "type": "array",
                "items": { "$ref": "/Group" },
                "uniqueItems": true
        ...
        "required": ["name", "projectId", "datasets", "views"]
    }

    v.addSchema(configAccessControlSchema, "/ConfigAccessControl");
    v.addSchema(datasetSchema, "/Dataset");
    v.addSchema(groupSchema, "/Group");
    v.addSchema(viewSchema, "/View");
    v.addSchema(sourceSchema, "/Source");
    v.addSchema(sourceAccessControlSchema, "/SourceAccessControl");
    v.addSchema(publicAccessSchema, "/PublicAccess");
    v.addSchema(customSchema, "/Custom");
    v.addSchema(expirationSchema, "/Expiration");
    v.addSchema(accessSchema, "/Access");

    let validationResult = v.validate(config, configSchema);
