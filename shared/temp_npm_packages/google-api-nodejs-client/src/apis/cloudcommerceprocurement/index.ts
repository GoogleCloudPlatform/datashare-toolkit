...
export function cloudcommerceprocurement(version: 'v1'): cloudcommerceprocurement_v1.Cloudcommerceprocurement;
...
>(
  ...
  versionOrOptions:
    | 'v1'
    | cloudcommerceprocurement_v1.Options
) {
  return getAPI<T>('cloudcommerceprocurement', versionOrOptions, VERSIONS, this);
}
