...
export declare namespace composer_v1beta1 {
    ...
    export interface Schema$AllowedIpRange {
        ...
        /**
         * IP address or range, defined using CIDR notation, of requests that this rule applies to. Examples: `192.168.1.1` or `192.168.0.0/16` or `2001:db8::/32`           or `2001:0db8:0000:0042:0000:8a2e:0370:7334`.   &lt;p&gt;IP range prefixes should be properly truncated. For example, `1.2.3.4/24` should be truncated to `1.2.3.0/24`. Similarly, for IPv6, `2001:db8::1/32` should be truncated to `2001:db8::/32`.
         */
        value?: string | null;
    }
    /**
    ...
    export interface Schema$DatabaseConfig {
        /**
         * Optional. Cloud SQL tier used by Airflow database. If not specified, db-n1-standard-2 will be used.
         */
    ...
    export interface Schema$WebServerConfig {
        /**
         * Optional. Machine type on which Airflow web server is running. For example: composer-n1-webserver-2, composer-n1-webserver-4, composer-n1-webserver-8. If not specified, composer-n1-webserver-2 will be used. Value custom is returned only in response, if Airflow web server parameters were manually changed to a non-standard values.
         */
        machineType?: string | null;
    }
    /**
