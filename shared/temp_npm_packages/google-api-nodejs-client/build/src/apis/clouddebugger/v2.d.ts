...
export declare namespace clouddebugger_v2 {
    ...
    export class Resource$Controller$Debuggees {
         ...
         */
        register(params: Params$Resource$Controller$Debuggees$Register, options: StreamMethodOptions): GaxiosPromise<Readable>;
    ...
    export class Resource$Controller$Debuggees$Breakpoints {
         ...
         * @return {object} Request object
         */
        list(params: Params$Resource$Controller$Debuggees$Breakpoints$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
         ...
         * @return {object} Request object
         */
        update(params: Params$Resource$Controller$Debuggees$Breakpoints$Update, options: StreamMethodOptions): GaxiosPromise<Readable>;
    ...
    export class Resource$Debugger$Debuggees {
         ...
         * @return {object} Request object
         */
        list(params: Params$Resource$Debugger$Debuggees$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
    ...
    export class Resource$Debugger$Debuggees$Breakpoints {
         ...
         * @return {object} Request object
         */
        delete(params: Params$Resource$Debugger$Debuggees$Breakpoints$Delete, options: StreamMethodOptions): GaxiosPromise<Readable>;
         ...
         * @return {object} Request object
         */
        get(params: Params$Resource$Debugger$Debuggees$Breakpoints$Get, options: StreamMethodOptions): GaxiosPromise<Readable>;
         ...
         * @return {object} Request object
         */
        list(params: Params$Resource$Debugger$Debuggees$Breakpoints$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
         ...
         * @return {object} Request object
         */
        set(params: Params$Resource$Debugger$Debuggees$Breakpoints$Set, options: StreamMethodOptions): GaxiosPromise<Readable>;
