...
export declare namespace youtube_v3 {
    ...
    export class Resource$Guidecategories {
        ...
        list(params: Params$Resource$Guidecategories$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
    ...
    export class Resource$Livebroadcasts {
         ...
         * @return {object} Request object
         */
        control(params: Params$Resource$Livebroadcasts$Control, options: StreamMethodOptions): GaxiosPromise<Readable>;
        control(params?: Params$Resource$Livebroadcasts$Control, options?: MethodOptions): GaxiosPromise<Schema$LiveBroadcast>;
        control(params: Params$Resource$Livebroadcasts$Control, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
    ...
    export class Resource$Sponsors {
         ...
         * @return {object} Request object
         */
        list(params: Params$Resource$Sponsors$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
        list(params?: Params$Resource$Sponsors$List, options?: MethodOptions): GaxiosPromise<Schema$SponsorListResponse>;
        list(params: Params$Resource$Sponsors$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
