...
export declare namespace people_v1 {
    ...
    export class Resource$V1 {
         ...
         * @return {object} Request object
         */
        otherContacts(params: Params$Resource$V1$Othercontacts, options: StreamMethodOptions): GaxiosPromise<Readable>;
        otherContacts(params?: Params$Resource$V1$Othercontacts, options?: MethodOptions): GaxiosPromise<Schema$ListOtherContactsResponse>;
        otherContacts(params: Params$Resource$V1$Othercontacts, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        otherContacts(params: Params$Resource$V1$Othercontacts, options: MethodOptions | BodyResponseCallback<Schema$ListOtherContactsResponse>, callback: BodyResponseCallback<Schema$ListOtherContactsResponse>): void;
        otherContacts(params: Params$Resource$V1$Othercontacts, callback: BodyResponseCallback<Schema$ListOtherContactsResponse>): void;
        otherContacts(callback: BodyResponseCallback<Schema$ListOtherContactsResponse>): void;
    }
