...
exports.cloudcommerceprocurement_v1 = void 0;
...
var cloudcommerceprocurement_v1;
(function (cloudcommerceprocurement_v1) {
    /**
    ...
    cloudcommerceprocurement_v1.Cloudcommerceprocurement = Cloudcommerceprocurement;
    ...
    cloudcommerceprocurement_v1.Resource$Providers = Resource$Providers;
    class Resource$Providers$Accounts {
        constructor(context) {
            this.context = context;
        }
        approve(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const rootUrl = options.rootUrl || 'https://cloudcommerceprocurement.googleapis.com/';
            const parameters = {
    ...
    cloudcommerceprocurement_v1.Resource$Providers$Accounts = Resource$Providers$Accounts;
    class Resource$Providers$Entitlements {
        constructor(context) {
            this.context = context;
        }
        approve(paramsOrCallback, optionsOrCallback, callback) {
        ...
        approvePlanChange(paramsOrCallback, optionsOrCallback, callback) {
            let params = (paramsOrCallback ||
                {});
            let options = (optionsOrCallback || {});
            if (typeof paramsOrCallback === 'function') {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+name}:approvePlanChange').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                }, options),
                params,
                requiredParams: ['name'],
        ...
        rejectPlanChange(paramsOrCallback, optionsOrCallback, callback) {
            let params = (paramsOrCallback ||
                {});
            let options = (optionsOrCallback || {});
            if (typeof paramsOrCallback === 'function') {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+name}:rejectPlanChange').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                }, options),
                params,
                requiredParams: ['name'],
    ...
    cloudcommerceprocurement_v1.Resource$Providers$Entitlements = Resource$Providers$Entitlements;
})(cloudcommerceprocurement_v1 = exports.cloudcommerceprocurement_v1 || (exports.cloudcommerceprocurement_v1 = {}));
