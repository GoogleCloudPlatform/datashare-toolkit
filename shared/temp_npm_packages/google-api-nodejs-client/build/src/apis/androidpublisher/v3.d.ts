...
export declare namespace androidpublisher_v3 {
    ...
    export class Resource$Systemapks$Variants {
        ...
        list(params?: Params$Resource$Systemapks$Variants$List, options?: MethodOptions): GaxiosPromise<Schema$SystemApkVariantsListResponse>;
        ...
        list(params: Params$Resource$Systemapks$Variants$List, options: MethodOptions | BodyResponseCallback<Schema$SystemApkVariantsListResponse>, callback: BodyResponseCallback<Schema$SystemApkVariantsListResponse>): void;
        list(params: Params$Resource$Systemapks$Variants$List, callback: BodyResponseCallback<Schema$SystemApkVariantsListResponse>): void;
        list(callback: BodyResponseCallback<Schema$SystemApkVariantsListResponse>): void;
    }
