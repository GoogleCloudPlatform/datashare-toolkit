...
For publisher projects that do not have the Cloud Functions API enabled at the time of running [deploy.sh](ingestion/function/bin/deploy.sh), the API will be enabled on the project's behalf.
