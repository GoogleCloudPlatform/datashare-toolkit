...
// mlcstPublisherCmd represents the mlcstPublisher command
var mlcstPublisherCmd = &cobra.Command{
	Use:   "publisher",
	Short: "BQDS client multicast publisher service",
	Long: `The BQDS client multicast publisher service will listen to a specific mlcst network group and address, then publish those messages to the specified PubSub Topic. For example:

-n "udp_mlcstPublisher_group_a"
-a "239.0.0.0:9999"
-i "en0"
-p "projectID"
-t "topicID"
`,
	Run: func(cmd *cobra.Command, args []string) {
		...
		log.Debugf("Starting Multicast Publisher Run...")
...
func init() {
	multicastCmd.AddCommand(mlcstPublisherCmd)
}
